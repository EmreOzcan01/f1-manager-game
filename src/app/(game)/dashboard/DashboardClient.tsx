      ...
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex items-center gap-2">
          <div className="px-3 py-1.5 rounded-xl bg-[var(--background-elevated)] border border-[var(--border-color)]">
            <p className="text-xs text-[var(--foreground-muted)]">Budget</p>
      ...
      <div className="animate-fade-in-up w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[var(--foreground-muted)]">
            Choose a name and color to start your F1 journey
          </p>
        </div>
        ...
        <form onSubmit={handleCreate} className="card p-6 space-y-5">
          ...
          <div className="rounded-xl p-3 border border-[var(--border-color)] bg-[var(--background)]">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-bold">{name || 'Your Team'}</p>
                <p className="text-[10px] text-[var(--foreground-muted)]">Season 1 • New Team</p>
              </div>
            </div>
          </div>
          ...
          <button
            ...
            id="btn-create-team"
          >
            {loading ? 'Creating...' : 'Establish Team 🏎️'}
          </button>
        </form>
      </div>
    </div>
